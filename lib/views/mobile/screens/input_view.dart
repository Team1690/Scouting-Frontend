                      ...
                      children: <Widget>[
                        ...
                        ...<CounterSpec>[
                          CounterSpec.purpleColors(
                            ...
                            Icons.arrow_circle_up_outlined,
                            () => match.teleCubesTop,
                            (final int score) => match.teleCubesTop = score,
                          ),
                          CounterSpec.purpleColors(
                            "Mid Scored",
                            Icons.adjust,
                            () => match.teleCubesMid,
                            (final int score) => match.teleCubesMid = score,
                          ),
                          CounterSpec.purpleColors(
                            "Low Scored",
                            Icons.arrow_circle_down,
                            () => match.teleCubesLow,
                            (final int score) => match.teleCubesLow = score,
                          ),
                          CounterSpec.purpleColors(
                            "Failed",
                            Icons.error_outline,
                            () => match.teleCubesFailed,
                            (final int score) => match.teleCubesFailed = score,
                          ),
                        ].map(_gamePieceCounters),
                      ]
                          .expand(
