...
class RatingPickList extends StatefulWidget {
  RatingPickList({
  ...
  @override
  State<RatingPickList> createState() => _RatingPickListState();
  final List<RatingPickListTeam> uiList;
}

class _RatingPickListState extends State<RatingPickList> {
  void reorderData(final int oldindex, int newindex) {
    if (newindex > oldindex) {
      newindex -= 1;
    }
    final RatingPickListTeam item = widget.uiList.removeAt(oldindex);
